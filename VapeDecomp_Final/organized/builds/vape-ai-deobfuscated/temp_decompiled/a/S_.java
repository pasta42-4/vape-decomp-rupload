...
public class s_ {
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, Object[] objectArray) {
        ...
        MethodHandle methodHandle = s_.a(lookup, mutableCallSite, string, methodType, l10, l11);
    ...
    private static Field b(Class clazz, String string, Class clazz2) {
        ...
        if (classArray != null) {
            for (int i10 = 0; i10 < classArray.length; ++i10) {
                field = s_.b(classArray[i10], string, clazz2);
    ...
    private static Method b(Class clazz, String string, Class clazz2, int n2, Class[] classArray) {
        Method method = s_.a(clazz, string, clazz2, n2, classArray);
        if (method != null) {
            return method;
        }
        ...
        if (classArray2 != null) {
            for (int i10 = 0; i10 < classArray2.length; ++i10) {
                method = s_.b(classArray2[i10], string, clazz2, n2, classArray);
    ...
    private static Method d(long l10, long l11) {
        ...
        if (object instanceof String) {
            ...
            block10: {
                ...
                clazz3 = s_.b(Long.parseLong(string2.substring(0, n4), 36), 0L);
                ...
                for (int i10 = 0; i10 < n6; ++i10) {
                    ...
                    clazz2 = s_.b(Long.parseLong(string2.substring(n7, n8), 36), 0L);
                    if (i10 < n3) {
                ...
                clazz = clazz3;
                do {
                    if ((classArray = s_.a(clazz, string, clazz2, n3, classArray2)) != null) {
                        s_.a[n2] = classArray;
                        return classArray;
                    }
            ...
            while (true) {
                if ((classArray = clazz.getInterfaces()) != null) {
                    for (int i11 = 0; i11 < classArray.length; ++i11) {
                        Method method = s_.b(classArray[i11], string, clazz2, n3, classArray2);
                        if (method == null) continue;
                        s_.a[n2] = method;
                        return method;
                    }
    ...
    public static int v(String string) {
        ...
        for (int i10 = 0; i10 < string.length(); ++i10) {
            int n3 = s_.q(string.charAt(i10));
            if (i10 + 1 < string.length()) {
                int n4 = s_.q(string.charAt(i10 + 1));
                if (n3 >= n4) {
                    n2 += n3;
                    continue;
                }
    ...
    private static Class b(long l10, long l11) {
        ...
        block2: {
            ...
            try {
                ...
                s_.a[n2] = clazz = Class.forName(b[n2]);
            }
    ...
    private static MethodHandle a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, long l10, long l11) {
        ...
        Method method = null;
        try {
            if (c10 == 'g' || c10 == 'd' || c10 == '\u00ed' || c10 == '\u00f6') {
                field = s_.c(l10, l11);
                Class<?> clazz = field.getDeclaringClass();
                String string2 = field.getName();
                Class<?> clazz2 = field.getType();
                methodHandle = c10 == 'g' ? lookup.findGetter(clazz, string2, clazz2) : (c10 == 'd' ? lookup.findSetter(clazz, string2, clazz2) : (c10 == '\u00ed' ? lookup.findStaticGetter(clazz, string2, clazz2) : lookup.findStaticSetter(clazz, string2, clazz2)));
            } else {
                method = s_.d(l10, l11);
                Class<?> clazz = method.getDeclaringClass();
                String string3 = method.getName();
                MethodType methodType2 = MethodType.methodType(method.getReturnType(), method.getParameterTypes());
                methodHandle = c10 == 'L' ? lookup.findVirtual(clazz, string3, methodType2) : (c10 == 'f' ? lookup.findStatic(clazz, string3, methodType2) : lookup.findSpecial(clazz, string3, methodType2, clazz));
            }
    ...
    private static Field c(long l10, long l11) {
        ...
        if (object instanceof String) {
            ...
            Class clazz = s_.b(Long.parseLong(string.substring(0, n3), 36), 0L);
            int n4 = string.indexOf(8, ++n3);
            String string2 = string.substring(n3, n4);
            Class clazz2 = s_.b(Long.parseLong(string.substring(++n4), 36), 0L);
            Class clazz3 = clazz;
            while (true) {
                Field field;
                ...
                if (classArray != null) {
                    for (int i10 = 0; i10 < classArray.length; ++i10) {
                        field = s_.b(classArray[i10], string2, clazz2);
                        if (field == null) continue;
                        s_.a[n2] = field;
                        return field;
                    }
    ...
    static {
        block9: {
            block8: {
                var11 = d8.a(-1597724136927895588L, -5741030127239790104L, MethodHandles.lookup().lookupClass()).a(74925673565611L) ^ 64000297222917L;
                s_.a = new Object[5];
                s_.b = new String[5];
                s_.a();
