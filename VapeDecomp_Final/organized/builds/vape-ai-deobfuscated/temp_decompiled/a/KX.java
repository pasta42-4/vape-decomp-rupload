...
extends ko {
     ...
     */
    static {
        b = d8.a(5929090553649129661L, 2428411446251592905L, MethodHandles.lookup().lookupClass()).a(30040027518045L);
        k = new HashMap(13);
        long l10 = b ^ 0x7E9314D423DFL;
    ...
    public kx() {
        long l10 = b ^ 0x54C210193E86L;
        super(a.cs((int)kx.b("f", (int)22257, (long)(0x6A8194E45552A166L ^ l10))), a.cs((int)kx.b("f", (int)3186, (long)(0x2B7AC9F0B8FAFBE4L ^ l10))));
    }

    public kx(String string, String string2) {
        super(string, string2);
    }

    private static int b(int n2, long l10) {
        int n3 = n2 ^ (int)(l10 & 0x7FFFL) ^ 0x35E3;
        if (j[n3] == null) {
            byte[] byArray;
    ...
    static MethodHandle cfr_ldc_0() {
        try {
            return MethodHandles.lookup().findStatic(kx.class, "b", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
