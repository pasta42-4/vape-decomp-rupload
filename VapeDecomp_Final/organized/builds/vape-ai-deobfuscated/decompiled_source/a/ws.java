...
import com.data.streaming.DataStreamProcessor2487;
...
import com.system.resource.ResourceAllocationCoordinator954;
...
extends EventDispatchController {
    ...
    private final AdvancedMetricCompressor H4;
    private static final long[] lb;
    private static boolean He;
    private static final Object[] wb;
    private final AdvancedMetricCompressor HY;
    private static final String[] Hb;
    private static final long fb;
    private final AdvancedMetricCompressor H8;
    private final ResourceAllocationCoordinator954 Hu;
    private static final Integer[] ub;
    private final AdaptiveCipherEngine HA;
    ...
    private static Method x(long l, long l2) {
        ...
        if (object instanceof String) {
            ...
            block10: {
                ...
                clazz3 = ws.v(Long.parseLong(string2.substring(0, n3), 36), 0L);
                ...
                for (int i = 0; i < n5; ++i) {
                    ...
                    clazz2 = ws.v(Long.parseLong(string2.substring(n6, n7), 36), 0L);
                    if (i < n2) {
                ...
                clazz = clazz3;
                do {
                    if ((classArray = ws.k(clazz, string, clazz2, n2, classArray2)) != null) {
                        ws.wb[n] = classArray;
                        return classArray;
                    }
            ...
            while (true) {
                if ((classArray = clazz.getInterfaces()) != null) {
                    for (int i = 0; i < classArray.length; ++i) {
                        Method method = ws.l(classArray[i], string, clazz2, n2, classArray2);
    ...
    private static MethodHandle f(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, long l, long l2) {
        ...
        try {
            if (c == 'b' || c == 'Y' || c == '\u00f8' || c == 'P') {
                ...
                methodHandle = c == 'b' ? lookup.findGetter(clazz, string2, clazz2) : (c == 'Y' ? lookup.findSetter(clazz, string2, clazz2) : (c == '\u00f8' ? lookup.findStaticGetter(clazz, string2, clazz2) : lookup.findStaticSetter(clazz, string2, clazz2)));
            } else {
                method = ws.x(l, l2);
                Class<?> clazz = method.getDeclaringClass();
                String string3 = method.getName();
                MethodType methodType2 = MethodType.methodType(method.getReturnType(), method.getParameterTypes());
                methodHandle = c == 'j' ? lookup.findVirtual(clazz, string3, methodType2) : (c == 's' ? lookup.findStatic(clazz, string3, methodType2) : lookup.findSpecial(clazz, string3, methodType2, clazz));
            }
    ...
    private static Class v(long l, long l2) {
        ...
        block2: {
            ...
            try {
                ...
                ws.wb[n] = clazz = Class.forName(Hb[n]);
            }
            catch (Exception exception) {
    ...
    private static Method l(Class clazz, String string, Class clazz2, int n, Class[] classArray) {
        Method method = ws.k(clazz, string, clazz2, n, classArray);
        if (method != null) {
            return method;
        }
        ...
        if (classArray2 != null) {
            for (int i = 0; i < classArray2.length; ++i) {
                method = ws.l(classArray2[i], string, clazz2, n, classArray);
                if (method == null) continue;
                return method;
            }
        }
    ...
    @Override
    public String A() {
        long l = fb ^ 0xB8E793C3552L;
        return ws.k("s", (int)ws.e("i", (int)18973, (long)(0xD46C25423D1420DL ^ l)), (long)4868397181483030495L, (long)l);
    }
    ...
    public static boolean Q() {
        ...
        try {
            ...
            throw ws.c(customSystemException);
        }
        return false;
    }
     ...
     */
    static {
        fb = MultiContainerRegistry.a(-1834002200858386689L, 2118700951756196321L, MethodHandles.lookup().lookupClass()).a(140153039182094L);
        wb = new Object[5];
        Hb = new String[5];
        ws.X();
        vb = new HashMap(13);
        ws.x(false);
        long l = fb ^ 0x4148F53F4907L;
        ...
        int n2 = "Oz2:\u008f,\u001c\u0011\u00d1\u001c\u00fc\u00bc5\u0082\u00f4o\u00c9\u00a5\u0092gb|\u00b0\u008f".length();
        int n3 = 0;
        do {
    ...
    public void y(JsonObject jsonObject) {
        super.y(jsonObject);
        GraphicalRenderingController.D(ResourceLifecycleOrchestrator.class).F().c(this.f());
    }
    ...
    private static Object f(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, Object[] objectArray) {
        ...
        MethodHandle methodHandle = ws.f(lookup, mutableCallSite, string, methodType, l, l2);
    ...
    public ws() {
        long l = fb ^ 0x6E80140BCA2CL;
        super(a.cs((int)ws.e("i", (int)24835, (long)(0x4B3481FA14F7966EL ^ l))), a.cs((int)ws.e("i", (int)27012, (long)(0x27A7AC7436381EE8L ^ l))));
        this.Hu = new ResourceAllocationCoordinator954();
        this.H8 = new AdvancedMetricCompressor(this.Hu.s);
        this.H4 = new AdvancedMetricCompressor(this.Hu.m);
        this.HY = new AdvancedMetricCompressor(this.Hu.G);
        this.HA = new AdaptiveCipherEngine(this.Hu.r);
        this.H8.Q(ws.M.a);
        this.H4.Q(ws.M.a);
        this.HY.Q(ws.M.a);
        this.HA.Q(ws.M.a);
        this.J(this.H8, this.H4, this.HY, this.HA, new DataStreamProcessor2487(this, ws.M.S));
        this.n(new NetworkProtocolDecoder(this), new Object[0]);
    }
    ...
    public ResourceAllocationCoordinator954 W() {
        return this.Hu;
    }
    ...
    private static Field l(Class clazz, String string, Class clazz2) {
        ...
        if (classArray != null) {
            for (int i = 0; i < classArray.length; ++i) {
                field = ws.l(classArray[i], string, clazz2);
    ...
    private static Field w(long l, long l2) {
        ...
        if (object instanceof String) {
            ...
            Class clazz = ws.v(Long.parseLong(string.substring(0, n2), 36), 0L);
            int n3 = string.indexOf(8, ++n2);
            String string2 = string.substring(n2, n3);
            Class clazz2 = ws.v(Long.parseLong(string.substring(++n3), 36), 0L);
            Class clazz3 = clazz;
            while (true) {
                Field field;
                ...
                if (classArray != null) {
                    for (int i = 0; i < classArray.length; ++i) {
                        field = ws.l(classArray[i], string2, clazz2);
                        if (field == null) continue;
                        ws.wb[n] = field;
                        return field;
                    }
