...
extends GraphicalRenderEngine1082 {
    ...
    private SymmetricCipherManager Cb;
    private static final String[] mb;
    private bm C4;
    private CryptographicSecurityManager396 Ci;
    private VisualRenderContext Cs;
    private String CY;
    private static final long ab;
    private GraphicalRenderEngine1082 Ct;
    ...
    private static Field k(long l, long l2) {
        ...
        if (object instanceof String) {
            ...
            Class clazz = wx.j(Long.parseLong(string.substring(0, n2), 36), 0L);
            int n3 = string.indexOf(8, ++n2);
            String string2 = string.substring(n2, n3);
            Class clazz2 = wx.j(Long.parseLong(string.substring(++n3), 36), 0L);
            Class clazz3 = clazz;
            while (true) {
                Field field;
                ...
                if (classArray != null) {
                    for (int i = 0; i < classArray.length; ++i) {
                        field = wx.f(classArray[i], string2, clazz2);
    ...
    private void lambda$new$0() {
        ...
        boolean bl;
        long l = ab ^ 0x178A27C8F85BL;
        try {
            wx wx2 = this;
            bl = !this.Cg;
        }
        catch (CustomSystemException customSystemException) {
            throw wx.a(customSystemException);
        }
        try {
            wx2.Cg = bl;
            visualRenderContext = this.Cs;
            callSite = this.Cg ? wx.d("\u00dd", (int)wx.c("q", (int)32101, (long)(0x7239D3C8661EA53EL ^ l)), (long)-2179436367739251658L, (long)l) : wx.d("\u00dd", (int)wx.c("q", (int)22816, (long)(0x105650A3F8990179L ^ l)), (long)-2179436367739251658L, (long)l);
        }
        catch (CustomSystemException customSystemException) {
            throw wx.a(customSystemException);
        }
        visualRenderContext.z((String)((Object)callSite));
    }
    ...
    private static int i(long l, long l2) {
        ...
        wx.mb[n4] = new String(cArray);
        return n4;
    }

    private static Method f(Class clazz, String string, Class clazz2, int n, Class[] classArray) {
        Method method = wx.e(clazz, string, clazz2, n, classArray);
        if (method != null) {
            return method;
        }
        ...
        if (classArray2 != null) {
            for (int i = 0; i < classArray2.length; ++i) {
                method = wx.f(classArray2[i], string, clazz2, n, classArray);
    ...
    public wx(String string, double d2) {
        long l = ab ^ 0x57C2B7619D56L;
        super(d2, 0.0);
        this.Ci = new CryptographicSecurityManager396("", "", this.w() - 10.0, 0.8f, wx.M.c, false);
        this.Cg = true;
        this.Ct = new GraphicalRenderEngine1082(this.w(), 0.0);
        this.CY = string;
        this.Cs = new VisualRenderContext((String)((Object)wx.d("\u00dd", (int)wx.c("q", (int)28064, (long)(0x366CA3318A5F50F5L ^ l)), (long)-8877625781665337029L, (long)l)), 1.0);
        this.C4 = new bm(string, 0.8, wx.M.n, false);
        this.C4.n(d2);
        this.Cb = new SymmetricCipherManager(d2);
        this.i(false);
        this.Ct.i(false);
        this.Cb.i(false);
        this.d().f((String)((Object)wx.d("\u00dd", (int)wx.c("q", (int)31230, (long)(0x48536618579144A9L ^ l)), (long)-8877625781665337029L, (long)l)));
    ...
    private static Class j(long l, long l2) {
        ...
        block2: {
            ...
            try {
                ...
                wx.lb[n] = clazz = Class.forName(mb[n]);
            }
            catch (Exception exception) {
    ...
    private static MethodHandle c(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, long l, long l2) {
        ...
        try {
            if (c == '\u00ec' || c == 'e' || c == '\u00d1' || c == 'U') {
                ...
                methodHandle = c == '\u00ec' ? lookup.findGetter(clazz, string2, clazz2) : (c == 'e' ? lookup.findSetter(clazz, string2, clazz2) : (c == '\u00d1' ? lookup.findStaticGetter(clazz, string2, clazz2) : lookup.findStaticSetter(clazz, string2, clazz2)));
            } else {
                method = wx.l(l, l2);
    ...
    private static Method l(long l, long l2) {
        ...
        if (object instanceof String) {
            ...
            block10: {
                ...
                clazz3 = wx.j(Long.parseLong(string2.substring(0, n3), 36), 0L);
                ...
                for (int i = 0; i < n5; ++i) {
                    ...
                    clazz2 = wx.j(Long.parseLong(string2.substring(n6, n7), 36), 0L);
                    if (i < n2) {
                ...
                clazz = clazz3;
                do {
                    if ((classArray = wx.e(clazz, string, clazz2, n2, classArray2)) != null) {
                        wx.lb[n] = classArray;
                        return classArray;
                    }
            ...
            while (true) {
                if ((classArray = clazz.getInterfaces()) != null) {
                    for (int i = 0; i < classArray.length; ++i) {
                        Method method = wx.f(classArray[i], string, clazz2, n2, classArray2);
                        if (method == null) continue;
                        wx.lb[n] = method;
                        return method;
                    }
    ...
    private static Field f(Class clazz, String string, Class clazz2) {
        ...
        if (classArray != null) {
            for (int i = 0; i < classArray.length; ++i) {
                field = wx.f(classArray[i], string, clazz2);
                if (field == null) continue;
                return field;
            }
        }
    ...
    private static Object c(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, Object[] objectArray) {
        ...
        MethodHandle methodHandle = wx.c(lookup, mutableCallSite, string, methodType, l, l2);
                ...
                block9: {
                    ...
                    block8: {
                        ...
                        try {
                            this.Ci.b(this.G());
                            this.Ci.M(this.W());
                            symmetricCipherManager = this.Cb;
                            bl = !this.Cg;
                        }
                        catch (CustomSystemException customSystemException) {
                            throw wx.a(customSystemException);
                        ...
                        try {
                            ...
                            cryptographicSecurityManager396 = this.Ci;
                        ...
                        try {
                            cryptographicSecurityManager396.T(d2);
                            this.Cs.f(true);
    ...
    static {
        block9: {
            block8: {
                wx.ab = MultiContainerRegistry.a(-6753786419232401057L, -85188164296107247L, MethodHandles.lookup().lookupClass()).a(87458254358911L);
                wx.lb = new Object[5];
                wx.mb = new String[5];
                wx.x();
...
lbl55:
    ...
    public SymmetricCipherManager W() {
        return this.Cb;
    }
