...
NetworkConfigurationResolver2717 {
    ...
    private DistributedResourceTracker W5;
    private boolean W6;
    ...
    public void S(UserInteractionEventDispatcher userInteractionEventDispatcher) {
        try {
            if (this.W5 != null) {
                this.W5.S(userInteractionEventDispatcher);
                return;
            }
        }
        catch (CustomSystemException customSystemException) {
            throw fH.a(customSystemException);
        }
    ...
    public void N() {
        block4: {
            block5: {
                try {
                    try {
                        if (this.W5 == null) break block4;
                        if (!this.W5.G()) break block5;
                    }
                    catch (CustomSystemException customSystemException) {
                        throw fH.a(customSystemException);
                    }
    ...
    private static Field o(long l, long l2) {
        ...
        if (object instanceof String) {
            ...
            while (true) {
                ...
                clazz3 = fH.n(241753974577983L, 0L);
            }
    ...
    public void Y(AuthenticationTokenGenerator268 authenticationTokenGenerator268) {
        for (AbstractComputationKernel abstractComputationKernel : this.A()) {
            try {
                try {
                    if (!(abstractComputationKernel instanceof DistributedResourceTracker) || !((DistributedResourceTracker)abstractComputationKernel).B().w().equals(authenticationTokenGenerator268.w())) continue;
                }
                catch (CustomSystemException customSystemException) {
                    throw fH.a(customSystemException);
                }
    ...
    public void E() {
        super.E();
        if (this.W5 != null) {
            double d2 = this.W5.W() + this.W5.b() - (this.W() + this.Q());
            try {
                if (d2 > 0.0) {
                    this.e(this.V() - d2);
                }
            ...
            ConfigurationManager.A(this.G(), this.W(), this.w(), Math.min(this.b(), this.Q()), EventDispatchCoordinator1159.y(this.l(), 100));
            this.W5.E();
        }
    }
    ...
    static {
        block9: {
            block8: {
                fH.ab = MultiContainerRegistry.a(5440549595009336343L, -5667436113647772432L, MethodHandles.lookup().lookupClass()).a(268481761856539L);
                fH.qb = new Object[5];
                fH.rb = new String[5];
                fH.T();
                fH.lb = new HashMap<K, V>(13);
                var0 = fH.ab ^ 121744243945665L;
                ...
                var8_3 = new long[4];
                var5_4 = 0;
                var6_5 = "\u008b7\u00db\u00e8\f\u00c1\u001f\u00c0\u0087\u00fd\u00c9\u00ab\"]g\u00a3";
                var7_6 = "\u008b7\u00db\u00e8\f\u00c1\u001f\u00c0\u0087\u00fd\u00c9\u00ab\"]g\u00a3".length();
                var4_7 = 0;
                while (true) {
...
lbl55:
    ...
    public void S(DistributedResourceTracker distributedResourceTracker) {
        this.W5 = distributedResourceTracker;
    }

    public void G(AuthenticationTokenGenerator268 authenticationTokenGenerator268) {
        this.o(new DistributedResourceTracker(this, authenticationTokenGenerator268));
    }
    ...
    public fH() {
        ...
        this.N(false);
        this.d().m(false);
        this.d().f((String)((Object)fH.e("S", (int)fH.d("o", (int)2049, (long)(0x570D5F37C7BA0F26L ^ l)), (long)1325317704257140396L, (long)l)));
        this.a(new DynamicParameterManager(this, (String)((Object)fH.e("S", (int)fH.d("o", (int)17966, (long)(0x1A8FE9E27BC2C10AL ^ l)), (long)1325317704257140396L, (long)l)), (String)((Object)fH.e("S", (int)fH.d("o", (int)11916, (long)(0x627EBEFF01EB29A9L ^ l)), (long)1325317704257140396L, (long)l))));
        this.o(new AuthenticationStateManager(this));
        WV = this;
    ...
    public DistributedResourceTracker V() {
        return this.W5;
    }
    ...
    private static MethodHandle d(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, long l, long l2) {
        ...
        try {
            if (c == '\u00d0' || c == '\u00e2' || c == '\u00f4' || c == 'x') {
                ...
                methodHandle = c == '\u00d0' ? lookup.findGetter(clazz, string2, clazz2) : (c == '\u00e2' ? lookup.findSetter(clazz, string2, clazz2) : (c == '\u00f4' ? lookup.findStaticGetter(clazz, string2, clazz2) : lookup.findStaticSetter(clazz, string2, clazz2)));
            } else {
                method = fH.p(l, l2);
    ...
    private void O() {
        for (AbstractComputationKernel abstractComputationKernel : this.A()) {
            ...
            abstractComputationKernel.N(this.W6);
        }
        this.A();
    }
    ...
    private static Class n(long l, long l2) {
        ...
        block2: {
            ...
            try {
                ...
                fH.qb[n] = clazz = Class.forName(rb[n]);
            }
            catch (Exception exception) {
    ...
    private static Method p(long l, long l2) {
        ...
        if (object instanceof String) {
            ...
            block10: {
                ...
                clazz = fH.n(241753974577983L, 0L);
            }
            clazz = clazz3;
            while (true) {
    ...
    private static void T() {
        ...
        fH.rb[1] = "java/lang/Integer";
        objectArray[2] = "\u0010qo'h\u0006\u001b~~h\u0015\u001e\byw!";
        objectArray[3] = "<7O\u0016?v78^Y^x<3Z\u0003";
        Object[] objectArray2 = objectArray;
        objectArray[4] = "$2#X'u3=c=\"2Nvj\u0003/(,w*\u0001rIw>j\u0000*1,56RI";
    }

    @Override
    public String A() {
        long l = ab ^ 0x5FE72AC56065L;
        return fH.e("S", (int)fH.d("o", (int)560, (long)(0x30528D17E21E54E2L ^ l)), (long)4868419942999598936L, (long)l);
    }
