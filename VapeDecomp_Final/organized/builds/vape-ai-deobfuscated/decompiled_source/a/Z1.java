...
extends Enum<z1> {
    ...
    private static Object a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, Object[] objectArray) {
        ...
        MethodHandle methodHandle = z1.a(lookup, mutableCallSite, string, methodType, l, l2);
    ...
    private static Method d(long l, long l2) {
        ...
        if (object instanceof String) {
            ...
            block10: {
                ...
                clazz3 = z1.b(Long.parseLong(string2.substring(0, n3), 36), 0L);
                ...
                for (int i = 0; i < n5; ++i) {
                    ...
                    clazz2 = z1.b(Long.parseLong(string2.substring(n6, n7), 36), 0L);
                    if (i < n2) {
                ...
                clazz = clazz3;
                do {
                    if ((classArray = z1.a(clazz, string, clazz2, n2, classArray2)) != null) {
                        z1.a[n] = classArray;
                        return classArray;
                    }
            ...
            while (true) {
                if ((classArray = clazz.getInterfaces()) != null) {
                    for (int i = 0; i < classArray.length; ++i) {
                        Method method = z1.b(classArray[i], string, clazz2, n2, classArray2);
    ...
    private static Class b(long l, long l2) {
        ...
        block2: {
            ...
            try {
                ...
                z1.a[n] = clazz = Class.forName(b[n]);
            }
    ...
    private z1(int n2, int n3, String string2) {
    ...
    private static MethodHandle a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, long l, long l2) {
        ...
        try {
            if (c == '\u00c7' || c == 'M' || c == '\u00d3' || c == '\u00f8') {
                ...
                methodHandle = c == '\u00c7' ? lookup.findGetter(clazz, string2, clazz2) : (c == 'M' ? lookup.findSetter(clazz, string2, clazz2) : (c == '\u00d3' ? lookup.findStaticGetter(clazz, string2, clazz2) : lookup.findStaticSetter(clazz, string2, clazz2)));
            } else {
                method = z1.d(l, l2);
                Class<?> clazz = method.getDeclaringClass();
                String string3 = method.getName();
                MethodType methodType2 = MethodType.methodType(method.getReturnType(), method.getParameterTypes());
                methodHandle = c == 'd' ? lookup.findVirtual(clazz, string3, methodType2) : (c == 'C' ? lookup.findStatic(clazz, string3, methodType2) : lookup.findSpecial(clazz, string3, methodType2, clazz));
            }
    ...
    static {
        block9: {
            block8: {
                var11 = MultiContainerRegistry.a(3749985415765531863L, -4734869367755925887L, MethodHandles.lookup().lookupClass()).a(148412959577064L) ^ 114475316729222L;
                z1.a = new Object[5];
                z1.b = new String[5];
                z1.a();
...
lbl53:
    ...
    private static Field b(Class clazz, String string, Class clazz2) {
        ...
        if (classArray != null) {
            for (int i = 0; i < classArray.length; ++i) {
                field = z1.b(classArray[i], string, clazz2);
    ...
    private static Field c(long l, long l2) {
        ...
        if (object instanceof String) {
            ...
            Class clazz = z1.b(Long.parseLong(string.substring(0, n2), 36), 0L);
            int n3 = string.indexOf(8, ++n2);
            String string2 = string.substring(n2, n3);
            Class clazz2 = z1.b(Long.parseLong(string.substring(++n3), 36), 0L);
            Class clazz3 = clazz;
            while (true) {
                Field field;
                ...
                if (classArray != null) {
                    for (int i = 0; i < classArray.length; ++i) {
                        field = z1.b(classArray[i], string2, clazz2);
                        if (field == null) continue;
                        z1.a[n] = field;
                        return field;
                    }
    ...
    private static Method b(Class clazz, String string, Class clazz2, int n, Class[] classArray) {
        Method method = z1.a(clazz, string, clazz2, n, classArray);
        if (method != null) {
            return method;
        }
        ...
        if (classArray2 != null) {
            for (int i = 0; i < classArray2.length; ++i) {
                method = z1.b(classArray2[i], string, clazz2, n, classArray);
                if (method == null) continue;
                return method;
            }
        }
