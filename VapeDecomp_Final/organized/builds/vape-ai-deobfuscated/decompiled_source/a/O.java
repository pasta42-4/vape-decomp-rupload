...
extends ConfigurationInitializer {
    ...
    final NetworkEndpointRegistrar Z;
    final HK e;
    ...
    private static MethodHandle a(MethodHandles.Lookup lookup, MutableCallSite mutableCallSite, String string, MethodType methodType, long l, long l2) {
        ...
        try {
            if (c == 'a' || c == 'k' || c == '\u00a3' || c == '\u00aa') {
                ...
                methodHandle = c == 'a' ? lookup.findGetter(clazz, string2, clazz2) : (c == 'k' ? lookup.findSetter(clazz, string2, clazz2) : (c == '\u00a3' ? lookup.findStaticGetter(clazz, string2, clazz2) : lookup.findStaticSetter(clazz, string2, clazz2)));
            } else {
                method = O.d(l, l2);
    ...
    private static int a(long l, long l2) {
        ...
        O.g[n4] = new String(cArray);
        return n4;
    }

    O(NetworkEndpointRegistrar networkEndpointRegistrar, HK hK, boolean[] blArray) {
        this.Z = networkEndpointRegistrar;
        this.e = hK;
        this.U = blArray;
    }
    ...
    private static Field c(long l, long l2) {
        ...
        if (object instanceof String) {
            ...
            while (true) {
                ...
                clazz3 = O.b(255056853082516L, 0L);
            }
            StringBuffer stringBuffer = new StringBuffer();
    ...
    private static CallSite b(MethodHandles.Lookup lookup, String string, MethodType methodType) {
        ...
        try {
            ...
            throw new RuntimeException("a/O" + " : " + string + " : " + methodType.toString(), exception);
        }
    ...
    private static int a(int n, long l) {
        ...
        if (c[n2] == null) {
            ...
            try {
                ...
                throw new RuntimeException("a/O", exception);
            }
     ...
     */
    static {
        a = MultiContainerRegistry.a(-5290932964959031348L, -5501718425210938182L, MethodHandles.lookup().lookupClass()).a(277513814566595L);
        f = new Object[5];
        g = new String[5];
        O.a();
        d = new HashMap(13);
        long l = a ^ 0x5B12AB4DB058L;
        ...
        int n = 0;
        String string = "\u00e8X\u00d2?)\u00a6\u00e8]\u00ca;j\u0011`\u00838\u00049\u00f6\u001e\u00bbF\u009c\u00da\u0012";
        int n2 = "\u00e8X\u00d2?)\u00a6\u00e8]\u00ca;j\u0011`\u00838\u00049\u00f6\u001e\u00bbF\u009c\u00da\u0012".length();
        int n3 = 0;
        do {
    ...
    private static void a() {
        ...
        O.g[1] = "java/lang/Integer";
        objectArray[2] = "mU.-K\u0003fZ?b6\u001bu]6+";
        objectArray[3] = "\b\u0012:\u0002\b\u001b\u0003\u001d+Mi\u0015\b\u0016/\u0017";
        Object[] objectArray2 = objectArray;
        objectArray[4] = "r\u0005\u0006$)01\u001f\u0007^'5IB\u0013n6\u007f5E\n5#Np\u001e\u0016np#7\u0005CnL";
    }
    ...
    public void P(MethodValidationProxy methodValidationProxy) throws ContextualExceptionHandler {
        block4: {
            long l = a ^ 0x56E16C807AB4L;
            try {
                try {
                    if (!methodValidationProxy.g().equals(this.e.B()) || !methodValidationProxy.t().equals(this.e.G())) break block4;
                }
                catch (ContextualExceptionHandler contextualExceptionHandler) {
                    throw O.a(contextualExceptionHandler);
                }
                this.U[0] = true;
                methodValidationProxy.N((String)((Object)O.b("$", (int)O.a("n", (int)26634, (long)(0x32E1DFA760E2267EL ^ l)), (long)-3539137937154628048L, (long)l)) + AsyncTaskHandler.class.getName() + (String)((Object)O.b("$", (int)O.a("n", (int)26387, (long)(0x2633052B68D12964L ^ l)), (long)-3539137937154628048L, (long)l)) + BackgroundJobProcessor.class.getName() + (String)((Object)O.b("$", (int)O.a("n", (int)5228, (long)(0x17881EA92C1ADA19L ^ l)), (long)-3539137937154628048L, (long)l)));
            }
            catch (ContextualExceptionHandler contextualExceptionHandler) {
                throw O.a(contextualExceptionHandler);
            }
    ...
    static MethodHandle cfr_ldc_1() {
        try {
            return MethodHandles.lookup().findStatic(O.class, "a", MethodType.fromMethodDescriptorString("(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/invoke/MutableCallSite;Ljava/lang/String;[Ljava/lang/Object;)I", null));
        }
        catch (NoSuchMethodException | IllegalAccessException except) {
            throw new IllegalArgumentException(except);
        }
